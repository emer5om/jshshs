...
import { AspectRatio, Box, Card, CardContent, CardOverflow, Grid, Typography, useTheme, styled, Checkbox } from '@mui/joy'
                                            ...
                                            <Box display={"flex"}
                                                ...
                                                <Box display={"flex"} alignItems={"center"} gap={1}>
                                                    {item.variants[0]?.special_price > 0 ?
                                                        <Typography sx={{ color: theme.palette.text.tertiary, textDecoration: "line-through" }} fontSize={theme.fontSize.xs} fontWeight={theme.fontWeight.sm}>
