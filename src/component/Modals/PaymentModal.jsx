...
const PaymentModal = ({ finalTotal, addressId, openModal, setModalOpen, message, deliveryType }) => {
    ...
    return (
        <Box>
            <Modal open={open} onClose={() => {
                ...
                <ModalDialog size='lg' sx={{ maxHeight: "100%", maxWidth: "100%", width: 500 }}>
                    <ModalClose />
                    ...
                    {openPaypal &&
                        <PaypalCheckout price={finalTotal} type={"placeOrder"} message={message} deliveryType={deliveryType}
                            isModalOpen={setModalOpen}
                            closeModal={setOpen}
                        />}

                    {openRazorPay &&
                        <RazorpayCheckout price={finalTotal} type={"placeOrder"} message={message}
                            isModalOpen={setModalOpen}
                            closeModal={setOpen}
                            deliveryType={deliveryType}
                        />}
                    {openStripe &&
                        <Stripe amount={finalTotal} type={"placeOrder"} message={message}
                            isModalOpen={setModalOpen}
                            closeModal={setOpen}
                            deliveryType={deliveryType}
                        />}
                    ...
                    {openCOD &&
                        <Button fullWidth variant='soft' onClick={() => handlePaymentOrder()} >
                            Place Order
                        </Button>
                    }
                </ModalDialog>
